...
for star_data in low_gravity_planets:
  planet_types.append(planet_data[6])

fig = px.scatter(x=star_name, y=star_mass, color=star_types)
fig.show()

for star_data in low_gravity_planets:
  planet_types.append(planet_data[6])

fig = px.scatter(x=star_name, y=star_radius, color=star_types)
fig.show()

for star_data in low_gravity_planets:
  planet_types.append(planet_data[6])

fig = px.scatter(x=star_name, y=star_distance, color=star_types)
fig.show()

for star_data in low_gravity_planets:
  planet_types.append(planet_data[6])

fig = px.scatter(x=star_name, y=star_gravity, color=star_types)
fig.show()